...
# Use
# python conlleval.py [-h] [-b STR] [-d CHAR] [-o CHAR] [file]
...
def parse(iterable, options=None):
    ...
    for line in iterable:
        ...
        if num_features is None:
            ...
            print('unexpected number of features: %d (%d)' %
        ...
        if len(features) < 3:
            print('unexpected number of features in line %s' % line)
...
def report(counts, out=None):
    ...
    return 100.*overall.prec, 100.*overall.rec, 100.*overall.fscore, c
...
if __name__ == '__main__':
    ...
    # sys.exit(main([None, 'data/BC2GM-IOBES/test.tsv'))
